...
pvector<NodeID> DOBFS(const Graph &g, NodeID source, int alpha = 15,
  ...
  uint64_t addr3e = reinterpret_cast<uint64_t>(&parent[g.num_nodes()]);
...
int main(int argc, char* argv[]) {
  // string edge_array = "edge_arr.log";
  // fstream f1 = Log::get_file_stream(edge_array);

  // string offset_array = "offset_arr.log";
  // fstream f2 = Log::get_file_stream(edge_array);
